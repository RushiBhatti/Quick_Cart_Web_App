...
<body>
	...
	<table id="customers">
		<tr>
			...
			<th scope="col">Mark as a Delivered <i class='fas fa-dolly'></i></i></th>
		</tr>
		...
		<tr>
			...
			<td><a href="../cancelOrdersServlet?id=<%=rs.getString(2) %>&email=<%=rs.getString(1) %>" >Cancel <i class='fas fa-window-close'></i></a></td>
			<td><a href="../deliveredOrdersServlet?id=<%=rs.getString(2) %>&email=<%=rs.getString(1) %>">Delivered <i class='fas fa-dolly'></i></i></a></td>
		</tr>
